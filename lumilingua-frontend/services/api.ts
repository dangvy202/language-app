...
export const fetchLogin = async (email: string, password: string) => {
  const endpoint = "https://securities-charleston-intersection-utilize.trycloudflare.com/api/v1/user/login"
...
export const fetchLevel = async ({ query }: { query: string }): Promise<Level[]> => {
  const endpoint = "https://col-monroe-committed-char.trycloudflare.com/api/level/"
...
export const fetchTopic = async ({ query }: { query: string }): Promise<Level[]> => {
  const endpoint = "https://col-monroe-committed-char.trycloudflare.com/api/topic/"
...
export const fetchVocabularyByTopic = async ({ nameTopic }: { nameTopic: string }): Promise<any[]> => {
  try {
    ...
    const endpoint = `https://col-monroe-committed-char.trycloudflare.com/api/vocabulary/?topic=${nameTopic}`;
...
export const fetchVocabularyByLevelId = async ({ levelId }: { levelId: number | string }): Promise<any[]> => {
  try {
    ...
    const endpoint = `https://col-monroe-committed-char.trycloudflare.com/api/vocabulary/?level=${levelId}`;
...
export const fetchMeanByVocabularyAndLanguage = async ({ vocabulary, language }: { vocabulary: number, language: number }): Promise<any[]> => {
  try {
    // const token = await AsyncStorage.getItem('accessToken'); // Lấy token nếu cần auth
    const endpoint = `https://col-monroe-committed-char.trycloudflare.com/api/mean/?vocabulary=${vocabulary}&language=${language}`
...
export const fetchInformation = async ({ query }: { query: string }): Promise<any[]> => {
  try {
    ...
    const endpoint = `https://securities-charleston-intersection-utilize.trycloudflare.com/api/v1/user/${email}`;
...
export const fetchUserCache = async ({ email }: { email: string }): Promise<any[]> => {
  try {
    const endpoint = `https://col-monroe-committed-char.trycloudflare.com/api/user_cache/?email=${email}`;
...
export const saveOrUpdateUserCache = async ({ id_user, email, phone, streak = 0, }: {
  ...
  try {
    ...
    const endpoint = `https://col-monroe-committed-char.trycloudflare.com/api/user_cache/`;
...
export const saveHistoryProgress = async ({
  ...
  try {
    ...
    const endpoint = "https://col-monroe-committed-char.trycloudflare.com/api/history_progress/";
...
export const getHistoryProgress = async (userCacheId: number) => {
  let endpoint = `https://col-monroe-committed-char.trycloudflare.com/api/history_progress/?user_cache=${userCacheId}`;

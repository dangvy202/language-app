...
// Type chung cho item (union type)
...
export default function LearnVocabulary() {
  ...
  const renderItem = ({ item }: { item: VocabularyItem }) => (
    ...
    >
      ...
      {/* Progress bar (nếu có) */}
      <View className="mb-4">
        {/* <Text className="text-gray-600 mb-2">Tiến độ: {item.progress || 0}%</Text> */}
      ...
      <View className="flex-row justify-end">
        <Text className="text-[#FFA500] font-medium">Học ngay →</Text>
      </View>
    </TouchableOpacity>
  );
        ...
        //   keyExtractor={(item) => item.id.toString()}
          ...
          ListEmptyComponent={
            <View className="flex-1 items-center justify-center py-20">
              ...
              <Text className="mt-4 text-xl text-gray-600 font-medium">
                Chưa có dữ liệu
              </Text>
            </View>
          }
